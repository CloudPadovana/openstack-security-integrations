...
from openstack_dashboard.dashboards.identity.registration_manager import views

prefix = 'openstack_dashboard.dashboards.identity.registration_manager.views'
